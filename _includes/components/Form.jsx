...
function Form({changeShape, changeFgColor, changeBgColor, bgColor, fgColor, shape}) {
    ...
    return (<>
        <form onSubmit={e => {
            ...
            <label htmlFor="bgcolor">Cap Background * 
                <input onInput={e => changeBgColor(e.target.value)} required defaultValue={bgColor} type="color" name="bgcolor" />
            </label>
            <label htmlFor="bgcolor">Cap Spot Color * 
                <input onInput={e => changeFgColor(e.target.value)} required defaultValue={fgColor} type="color" name="fgcolor" />
            </label>
            <label htmlFor="shape">Cap Shape 
                <select onInput={e => changeShape(e.target.value)} defaultValue={shape} name="shape">
            ...
            <button type="submit">Save my mushroom</button>
        </form>
        </>
    )
}
